...
const cryptoOptions: PaymentOption[] = [
  {
    ...
    networks: [
      { name: "Bitcoin", address: config.crypto.btcOnchain },
    ],
  },
  {
    id: "cngn",
    ...
    networks: [
      ...
      { name: "BSC", address: config.crypto.evmAddress },
    ],
  },
  {
    id: "usdt",
    ...
    networks: [
      ...
      { name: "Base", address: config.crypto.usdtEvmAddress },
      { name: "BSC (BEP20)", address: config.crypto.usdtEvmAddress },
    ],
  },
  {
    id: "usdc",
